...
const SHOP_NAME = 'Cửa hàng Cây Xanh';
...
export default function ShopInfoScreen() {
  ...
  const onDirections = () =>
    Linking.openURL(
      // Có toạ độ thì thay "query" bằng "destination=lat,lng"
    ...
    <SafeAreaView style={s.container}>
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.card}>
          ...
          <View style={s.row}>
            ...
            <View style={s.rowBody}>
              ...
              <View style={[s.badge, { backgroundColor: openNow ? '#e6f5ec' : '#feeceb' }]}>
                <View
                  style={[
                    s.dot,
                ...
                />
                <Text
                  style={{ color: openNow ? '#256d3a' : '#b91c1c', fontWeight: '700' }}
                >
        ...
        <View style={s.card}>
          ...
          <Text style={s.intro}>
            {`Chúng tôi cung cấp đa dạng cây nội thất, sen đá, xương rồng, phụ kiện chăm sóc.
Chính sách tư vấn chọn cây theo ánh sáng - diện tích phòng, bảo hành đổi cây trong 7 ngày.`}
          </Text>
        ...
        {/* Album ảnh (demo lấy từ assets) */}
        <View style={[s.card, { paddingBottom: 14 }]}>
          <Text style={s.sectionTitle}>Hình ảnh</Text>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginTop: 8 }}>
            <Image source={require('../../assets/plant1.png')} style={s.photo} />
            <Image source={require('../../assets/plant2.png')} style={s.photo} />
            <Image source={require('../../assets/plant3.png')} style={s.photo} />
            <Image source={require('../../assets/plant4.png')} style={s.photo} />
          </ScrollView>
        </View>

        {/* Map placeholder (nếu chưa dùng map) */}
...
const s = StyleSheet.create({
  ...
  photo: {
    ...
    marginRight: 10, backgroundColor: '#f3f4f6',
  },

  mapCard: {
    width: '100%', maxWidth: CARD_MAX_W,
    flexDirection: 'row', alignItems: 'center',
